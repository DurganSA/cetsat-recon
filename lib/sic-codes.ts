// UK SIC 2007 code -> plain-English description, sourced from the official ONS/Companies
// House classification (https://resources.companieshouse.gov.uk/sic/). Companies House
// SIC codes are 5-digit, zero-padded. Codes not in this map fall back to showing the raw
// code rather than a guessed description - honest gaps, not fabricated ones.
export const SIC_CODE_DESCRIPTIONS: Record<string, string> = {
